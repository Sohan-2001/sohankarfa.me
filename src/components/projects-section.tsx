...
const projects = [
  ...
  },
  {
    ...
    description: "An interactive chat application that simulates a conversation with an AI-powered astrologer. Users can ask questions about their life, future, and destiny to receive personalized astrological insights in real-time.",
    image: "https://sxldi6vsg8pc7vjq.public.blob.vercel-storage.com/aiastrologer-ten.vercel.app_.png",
    alt: "Screenshot of the A.I. Astrologer application",
